...
use self::blogpost_handler::{
    ...
    downvote_handler_dec, downvote_handler_inc, get_blog_by_uid, get_comment, get_post, get_posts,
    get_user_posts, like_handler_dec, like_handler_inc, patch_comment, patch_posts, patch_reply,
